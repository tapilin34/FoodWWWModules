...
function calc () {
        ...
        function calcTotal() {
            ...
            switch (sex) {
                case 'female' : result.textContent = Math.round((447.6 + (9.2 * weight) + (3.1 * height) - (4.3 * age)) * ratio);
                break;
                case 'male' : result.textContent = Math.round((88.36 + (13.4 * weight) + (4.8 * height) - (5.7 * age)) * ratio);
                break;
            }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "getResource": () => (/* reexport safe */ _services_services__WEBPACK_IMPORTED_MODULE_0__.getResource)
/* harmony export */ });
...
function forms (formSelector,modalTimerId) {
    ...
    const message = {
        ...
        success: 'Успех',
        failure: 'Что-то пошло не по плану...'
    };
    ...
    function showThanksModal(message) {
        ...
        <div class=" __close" data-close>×</div>
...
function slider ({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    ...
    previousSlideBtn = document.querySelector(prevArrow),
...
(0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer','2022-09-25');
